...
namespace XivApi.Character
{
    public static class CharacterEndpoints
    {
        private static readonly string Columns = string.Join(',', "Character.ClassJobs", "Character.Name", 
            ...
            "Character.Server", "Character.ClassJobsElemental", "Character.ClassJobsBozjan", "FreeCompany.Name", 
            "FreeCompany.Tag", "FreeCompany.Crest", "FreeCompany.ID", "Character.Title.Name", "Character.Race", 
            "Character.Tribe", "Character.TitleTop", "Character.Nameday", "Character.GuardianDeity", 
            "Character.GrandCompany", "Character.Gender");
